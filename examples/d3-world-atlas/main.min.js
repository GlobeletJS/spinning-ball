var example = (function (exports) {
  ...
  function main() {
    ...
    function renderPrep() {
      ...
      let lon = ball.cameraPos[0] * degrees$2;
      let lat = ball.cameraPos[1] * degrees$2;
      let alt = ball.cameraPos[2];
      let snyderP = 1 + alt / ball.radius();
      let visibleYextent = 2 * alt * Math.tan(0.5 * fieldOfView / degrees$2);
      let scale = ball.radius() * numPixelsY / visibleYextent;

      projection.scale(scale)
        .rotate([-lon, -lat, 0])
        .distance(snyderP)
        .clipAngle(Math.acos(1 / snyderP) * degrees$2);
    }
