...
export function initEllipsoid() {
  ...
  function shootEllipsoid(intersection, camera, rayVec) {
    ...
    var a = vec3.dot(mRay, mRay);
    var b = 2.0 * vec3.dot(mRay, mCam);
    var c = vec3.dot(mCam, mCam) - 1.0;
